...
def Generate():
    ...
    ######
    file = open(PathManage.script_path + "/" + "TableManager.cs", "w+")
    file.write(strMangerSc)
    file_tablesheetHolder = open(PathManage.script_path + "/" + "TableSheetHolder.cs", "w+")
    file_tablesheetHolder.write(conststr_tablesheet_holder)
    ######
    # file_project = open(PathManage.project_script_path + "/" + "TableManager.cs", "w+")
    # file_project.write(strMangerSc)
    # file_proeject_tablesheetHolder = open(PathManage.project_script_path + "/" + "TableSheetHolder.cs", "w+")
